...
from events.views import index, dashboard, EventListView, EventDetailView, EventCreateView, EventDeleteView, EventUpdateView, register_for_event, edit_registration, delete_registration, my_events, view_registrations, custom_register_for_event, customise_reg_form, view_event, view_event_by_hashed_url
...
urlpatterns = [
    ...
    path('<str:url>/', view_event, name = 'view_event'),
